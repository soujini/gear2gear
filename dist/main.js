...
/* harmony import */ var _components_investment_reocrds_investment_reocrds_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./components/investment-reocrds/investment-reocrds.component */ "./src/app/components/investment-reocrds/investment-reocrds.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_investment_reocrds_investment_reocrds_component__WEBPACK_IMPORTED_MODULE_31__["InvestmentReocrdsComponent"],
            ],
            imports: [
...
var TransactionDetailsComponent = /** @class */ (function () {
        ...
        this.carService.sold.subscribe(function (value) {
            if (value == true) {
                ...
                if (_this.carForm.get('selling_price').value != 0 && _this.carForm.get('selling_price').value != '' && _this.carForm.get('selling_price').value != null) {
                    _this.transactionDetailsService.getTotalInvestmentAndBalanceByCar(_this.carForm.get('car_id').value)
                        .subscribe(function (res) {
                        if (res.length > 0) {
                            if (res[0].balance == 0) {
                                _this.getInvestorsExpensesAndPercent();
                            }
                            else {
                                window.scrollTo(0, 0);
                                _this.message = "Please enter an investment amount to match the cost price", +res[0].balance;
                                _this.opMessage.emit(_this.message);
                                setTimeout(function () {
                                    _this.message = "";
                                    _this.opMessage.emit(_this.message);
                                }, 5000);
                            ...
                            window.scrollTo(0, 0);
                            _this.message = "Please enter an investment amount to match the cost price";
                            _this.opMessage.emit(_this.message);
                            setTimeout(function () {
                                _this.message = "";
                                _this.opMessage.emit(_this.message);
                ...
                _this.clientService.getInvestorsExpensesAndPercent(_this.carForm.get('car_id').value)
                    .subscribe(function (res) {
                    _this.investorsExpensesAndPercent$ = res;
                    _this.transactionDetailsService.deleteProfitOrLossTransactionDetails(_this.carForm.get('car_id').value, _this.investorsExpensesAndPercent$)
                        .subscribe(function (res) {
                    }, function (err) {
                    });
                });
    ...
    TransactionDetailsComponent.prototype.getInvestorsExpensesAndPercent = function () {
        var _this = this;
    ...
    TransactionDetailsComponent.prototype.deleteProfitOrLossTransactionDetails = function () {
        ...
        this.transactionDetailsService.deleteProfitOrLossTransactionDetails(this.carForm.get('car_id').value, this.investorsExpensesAndPercent$)
            ...
            _this.createProfitOrLossTransactionDetails();
        }, function (err) {
        });
    };
    TransactionDetailsComponent.prototype.createProfitOrLossTransactionDetails = function () {
        var _this = this;
        var credit = 0;
        var debit = 0;
        ...
        this.investorsExpensesAndPercent$.forEach(function (record) {
            console.log('Investors Expense and Investment Percent ', record);
            //Caculate investors total income from the car
            var investors_total_income_car = (parseFloat(record.investors_percent) / 100) * parseInt(_this.carForm.get('selling_price').value.toString().replace(/,/g, ""));
            //Calculate total cost of the car(Expenses + Cost Price)
            var total_cost_price_car = parseInt(record.car_total_cost);
            //Calculate profit ot loss of the car
            var total_profit_car = parseInt(_this.carForm.get('selling_price').value.toString().replace(/,/g, "")) - total_cost_price_car;
            //Calculate investors profit or loss and update available balance
            var investors_total_profit_car = (parseFloat(record.investors_percent) / 100) * total_profit_car; //Add to Transaction details as profit or loss
            ...
            if (investors_total_profit_car > 0) {
            ...
            _this.transactionDetailsForm.updateValueAndValidity({ emitEvent: false, onlySelf: true });
    ...
    TransactionDetailsComponent.prototype.getSelectedTransactionTypeMode = function (transactionTypeId) {
        ...
        this.transactionTypes$.subscribe(function (res) {
            ...
            if (transactionType[0].mode == "credit") {
                ...
                _this.transactionDetailsForm.get('debit').updateValueAndValidity({ emitEvent: false, onlySelf: true });
                _this.transactionDetailsForm.get('investor_id').clearValidators();
                _this.transactionDetailsForm.get('investor_id').disable();
                _this.transactionDetailsForm.get('investor_id').updateValueAndValidity({ emitEvent: false, onlySelf: true });
            }
            else {
                _this.transactionDetailsForm.get('debit').enable();
                ...
                //Enable Investor
                _this.transactionDetailsForm.get('investor_id').enable();
                _this.transactionDetailsForm.get('investor_id').setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required);
                _this.transactionDetailsForm.get('investor_id').updateValueAndValidity({ emitEvent: false, onlySelf: true });
            }
        });
    };
    ...
    TransactionDetailsComponent.prototype.createTransactionDetails = function () {
        var _this = this;
        var investor_id = parseInt(this.transactionDetailsForm.get('investor_id').value);
        var car_id = 0;
        ...
        if (this.transactionDetailsForm.get('transaction_type_mode').value == 'debit') {
            if (parseInt(this.transactionDetailsForm.get('debit').value.replace(/,/g, "")) <= this.investors_available_balance) {
                var total_cost = this.carForm.get('total_cost').value + parseInt(this.transactionDetailsForm.get('debit').value.replace(/,/g, ""));
                this.transactionDetailsForm.patchValue({
            ...
            var total_income = this.carForm.get('total_income').value + parseInt(this.transactionDetailsForm.get('credit').value.replace(/,/g, ""));
            this.transactionDetailsForm.patchValue({
            ...
            this.transactionDetailsService.createTransactionDetails(this.transactionDetailsForm.value)
                .subscribe(function (res) {
                _this.transactionDetailsForm.reset();
                _this.transactionDetailsService.refreshList.next(true);
            }, function (err) {
                console.log(err);
            }, function () {
            });
    ...
    TransactionDetailsComponent.prototype.onSubmit = function () {
        ...
        var mode = this.transactionDetailsForm.get('transaction_type_mode').value;
        if (mode == 'credit') {
    ...
    TransactionDetailsComponent.prototype.getAvailableBalanceTotalExpensesTotalInvestment = function () {
        var _this = this;
        if (this.transactionDetailsForm.valid) {
            var investor_id = parseInt(this.transactionDetailsForm.get('investor_id').value);
            this.clientService.getAvailableBalance(investor_id).subscribe(function (res) {
                _this.total_investment_balance = res;
                if (res.total_investment != null) {
                    _this.investors_total_investment = parseInt(res.total_investment.toString().replace(/,/g, ""));
                }
                if (res.total_expenses != null) {
                    _this.investors_total_expenses = parseInt(res.total_expenses.toString().replace(/,/g, ""));
                }
                if (_this.transactionDetailsForm.get('transaction_type_id').value == 1) {
                    _this.checkInvestmentBalance();
                }
                else {
                    _this.investors_total_expenses = parseInt(res.total_expenses) + parseInt(_this.transactionDetailsForm.get('debit').value.toString().replace(/,/g, ""));
                    _this.available_balance = parseInt(res.total_investment) - _this.investors_total_expenses;
    ...
    TransactionDetailsComponent.prototype.checkInvestmentBalance = function () {
        var _this = this;
        var invalid_amount;
        this.transactionDetailsService.getTotalInvestmentAndBalanceByCar(this.carForm.get('car_id').value)
            .subscribe(function (res) {
            if (res.length > 0) {
                var investment_amount = parseInt(_this.transactionDetailsForm.get('debit').value.toString().replace(/,/g, ""));
                if (investment_amount > parseInt(res[0].balance)) {
                    invalid_amount = true;
                    _this.message = "The maximum amount cannot exceed the balance of Rs. " + res[0].balance;
                    setTimeout(function () {
                        _this.message = "";
                    }, 5000);
                }
                ...
                var investment_amount = parseInt(_this.transactionDetailsForm.get('debit').value.toString().replace(/,/g, ""));
                var cost_price = parseInt(_this.carForm.get('cost_price').value.toString().replace(/,/g, ""));
                if (investment_amount > cost_price) {
                    invalid_amount = true;
                    _this.message = "The maximum amount cannot exceed the balance of Rs. " + cost_price;
                    setTimeout(function () {
                        _this.message = "";
                    }, 5000);
                }
            ...
            if (invalid_amount == false) {
                _this.investors_total_expenses = parseInt(_this.total_investment_balance.total_expenses) + parseInt(_this.transactionDetailsForm.get('debit').value.toString().replace(/,/g, ""));
                _this.available_balance = parseInt(_this.total_investment_balance.total_investment) - _this.investors_total_expenses;
                _this.createTransactionDetails();
            }
        });
    };
    TransactionDetailsComponent.prototype.validateAmountAgainstBalance = function () {
        var _this = this;
        var investor_id = this.transactionDetailsForm.get('investor_id').value;
        this.clientService.getAvailableBalance(investor_id).subscribe(function (res) {
            _this.investors_available_balance = (parseInt(res.available_balance.toString().replace(/,/g, "")));
        }, function (err) {
        });
    };
...
var InventoryComponent = /** @class */ (function () {
    function InventoryComponent(carService) {
        this.carService = carService;
...
/***/ "./src/app/components/investment-reocrds/investment-reocrds.component.html":
/*!*********************************************************************************!*\
  !*** ./src/app/components/investment-reocrds/investment-reocrds.component.html ***!
  \*********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/investment-reocrds/investment-reocrds.component.scss":
/*!*********************************************************************************!*\
  !*** ./src/app/components/investment-reocrds/investment-reocrds.component.scss ***!
  \*********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/investment-reocrds/investment-reocrds.component.ts":
/*!*******************************************************************************!*\
  !*** ./src/app/components/investment-reocrds/investment-reocrds.component.ts ***!
  \*******************************************************************************/
/*! exports provided: InvestmentReocrdsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InvestmentReocrdsComponent", function() { return InvestmentReocrdsComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var InvestmentReocrdsComponent = /** @class */ (function () {
    function InvestmentReocrdsComponent() {
    }
    InvestmentReocrdsComponent.prototype.ngOnInit = function () {
    };
    InvestmentReocrdsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-investment-reocrds',
            template: __webpack_require__(/*! ./investment-reocrds.component.html */ "./src/app/components/investment-reocrds/investment-reocrds.component.html"),
            styles: [__webpack_require__(/*! ./investment-reocrds.component.scss */ "./src/app/components/investment-reocrds/investment-reocrds.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], InvestmentReocrdsComponent);
    return InvestmentReocrdsComponent;
}());
